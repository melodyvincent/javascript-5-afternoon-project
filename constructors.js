...
var honda = CarFactory('Toyota', 'Highlander');
var nissan = CarFactory('Nissan', 'Sentra');
...
Movie.prototype.changeRating = function(){
  return this.rating;
  // console.log(this.name, this.genre, this.rating);
}
var ToyStory = new Movie('Toy Story', 'Family', 'G');
ToyStory.changeRating();
